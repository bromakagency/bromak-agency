  ...
  return (
    <section className="social-video-showcase">
      <div className="video-showcase-heading">
        <span>PERFORMANS VİDEOLARI</span>
        <h2>
          Dönüşüm odaklı kreatifler<span>.</span>
        </h2>
        <p>
          Dikkat sürelerinin saniyelere indiği platformlarda, izleyiciyi yakalayan 
          ve harekete geçiren (CTA) video reklam tasarımları kurguluyoruz.
        </p>
      </div>
